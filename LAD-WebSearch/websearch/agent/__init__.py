...
import websearch.agent.models as llm_factory
from websearch.agent.websearch_agent import (WebSearchAgent,
                                               WebSearchProtocol)
from websearch.agent.websearch_prompt import (
...
def init_agent(lang='cn', model_format='internlm_server',search_engine='DuckDuckGoSearch'):
    ...
    agent = WebSearchAgent(
        llm=llm,
        protocol=WebSearchProtocol(meta_prompt=datetime.now().strftime(
